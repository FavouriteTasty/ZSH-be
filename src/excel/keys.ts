import {
    type FollowupExtra,
    type Hospitalization5E5Q5LScale,
    type HospitalizationBasic,
    type HospitalizationBloodLipids,
    type HospitalizationBloodRoutine,
    type HospitalizationBodyComposition,
    type HospitalizationElectrolyte,
    type HospitalizationHormone,
    type HospitalizationLiverFunction,
    type HospitalizationOther,
    type HospitalizationSugarMetabolism,
    type MedicalHistory,
    type PreoperativeExaminationForStentRemovalExtra,
    type StentPlacement,
    type StentRemoval,
    type TableActions,
    type UserProfile,
